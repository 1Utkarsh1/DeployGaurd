...
import { useCreateScan, useGetScan, getListScansQueryKey, getGetScanStatsQueryKey } from "@workspace/api-client-react";
...
export default function Home() {
    ...
    mutation: {
      ...
      onError: (error) => {
        toast({
          variant: "destructive",
          title: "Scan failed",
          description: error.error || "An error occurred while scanning the URL.",
        });
      }
    }
  });
  ...
  const handleDemoMode = (demoData: ScanResult) => {
    setActiveScan(demoData);
    setSelectedScanId(null);
  };
